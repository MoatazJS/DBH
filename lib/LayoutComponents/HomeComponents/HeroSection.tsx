    ...
    <>
      <main className="min-h-screen bg-black flex flex-col gap-4 md:gap-6">
        ...
        <div className="text-center">
          <h1 className="text-white text-5xl md:text-9xl font-extrabold tracking-tight">
            VISION
          </h1>
          <h1 className="text-5xl md:text-9xl font-extrabold bg-linear-to-r from-[#7793FF] to-[#A6A6A6] bg-clip-text text-transparent tracking-tight">
            UNBOUND
          </h1>
        </div>
        <div className="text-center">
          <p className="text-[#A6A6A6] text-lg md:text-xl">
